...
public class PerformDepositController extends GenericController {

	private void performValidation(HttpServletRequest request, String passwordHash,
	...
	public void handleRequest(HttpServletRequest request,
		...
		try
		{
			...
			performValidation(request, user.getPassword(), errors, values);
